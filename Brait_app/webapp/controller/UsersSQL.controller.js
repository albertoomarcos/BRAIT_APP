sap.ui.define([ "sap/ui/core/mvc/Controller", "sap/m/MessageToast" ], function(
	...
	return Controller.extend("apps.App", {
		...
		eventoPress : function(evt) {
			...
			bebidaSeleccionada = evt.getParameter("listItem")
					.getBindingContext().getProperty("descripcion");
			idbebidaSeleccionada = evt.getParameter("listItem")
					.getBindingContext().getProperty("idCategoria");
			MessageToast.show("bebida seleccionada: " + bebidaSeleccionada
					+ " Y su ID: " + idbebidaSeleccionada);
		}
	});
